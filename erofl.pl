...
my %funcs2 = (
  ...
  "<e>"              => [ "e-" ],
  "<epsilon>"        => [ "" ],
  "<noun>"           => [ "infrastructure", "architecture", "initiative", "Mommy", "DOG", "server", "application", "framework", "platform", "attestation", "workflow", "flow", "transaction", "agency", "paradigm", "blockchain" ],
  ...
  "<real_adjective>" => [ "business", "functional", "perspective", "Global", "corporate", "ROFL", "info shared", "synergistic", "B2B", "business-enabled", "web-enabled", "websphere-enabled", "J2EE", "modular", "contactable", "LOL", "re-architecture", "deliverable", "flexible", "dynamic", "end <space> to <space> end", "distributed" ],
  "<space>"          => [ "" ],
